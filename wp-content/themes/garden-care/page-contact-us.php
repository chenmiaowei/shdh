        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-title text-center">
                    ...
                    <a href="<?php home_url(); ?>">Home</a> <i class="fa fa-angle-right"></i> <span>contact us</span>
                </div> <!-- /.page-breadcumb -->
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="section-title2">
            ...
            <p class="title-text">You can talk to our online representative at any time. Please use our Live Chat System on our website or Fill up below instant messaging programs.
                Please be patient, We will get back to you. Our 24/7 Support, General Inquireies Phone: +61-2-98680284</p>
        </div>
        <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="contact-address-single-info">
                        ...
                        <div class="contact-address-text">
                            <p>Suite 2/123 Midson Rd,<br />Epping, NSW, Australia, 2121</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 contact-content-form">
                <?php
                echo do_shortcode('[contact-form-7 id="336" title="contactus_copy"]');
                ?>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
